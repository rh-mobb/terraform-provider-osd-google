...
page_title: "osdgoogle_wif_config Data Source - osdgoogle"
subcategory: ""
description: |-
  Look up an existing WIF config by display_name or id. Use with modules/osd-wif-gcp to provision GCP IAM resources. Display name is preferred since it is known at plan time without passing IDs between Terraform configs.
---
...
- `workload_identity_pool` (Attributes) Workload identity pool blueprint from OCM. Use with modules/osd-wif-gcp. (see [below for nested schema](#nestedatt--gcp--workload_identity_pool))
